...
function BuildPVMessage(bestMove, value, timeTaken, ply) {
    ...
    var scoreDisplay;
    if (Math.abs(value) >= 1999900) {
        var movesToMate = Math.ceil((2000000 - Math.abs(value)) / 2);
        scoreDisplay = "M" + movesToMate;
    } else {
        scoreDisplay = (value / 1000).toFixed(2);
    }

    return "depth: " + ply + ", Evaluation: " + scoreDisplay + " Nodes:" + totalNodes + " NPS:" + ((totalNodes / (timeTaken / 1000)) | 0) + " " + PVFromHash(bestMove, 15);
}
